...
import { SideNav, NAV_ITEMS, SIDENAV_WIDTH, DS_THEME_KEY, readDarkPref } from './components/design-system/SideNav';
...
export default function DesignSystemPage() {
  ...
  return (
    ...
    <div style={{ background: isDark ? '#1F1A14' : '#E8DFCC', minHeight: '100vh', transition: 'background 300ms ease' }}>
      <SideNav theme={theme} activeL1={activeL1} activeL2={activeL2} isDark={isDark} onToggle={handleThemeToggle} />
      <div style={{
